...
namespace Repositroy_And_Services.Repository
{
    public class Repository<T> : IRepository<T> where T : BaseEntityClass
    {
        ...
        public Task<IQueryable<Leave>> GetAllLeaves()
        {
            var result = _context.Set<Leave>().AsQueryable();
            return Task.FromResult(result);
        }

        public Task<IQueryable<User>> GetAllUserList()
        {
            var result = _context.Set<User>().AsQueryable();
            return Task.FromResult(result);
        }
    }
}
